        ...
        <div className="product__border" key={product?._id}>
          <div className="products__card">
            ...
            >
              ...
              <p>{product?.price || "Narxlanmagan"} UZS</p>
            </Link>
            <div className="button__wrapper">
              <button
                onClick={() =>
                ...
                className="product__button" disabled={isProductInCart(product?._id) ? true : false} 
              >
                {isProductInCart(product?._id) ? "Added" : "Savatga qo`shish"  }
              </button>
            </div>
          </div>
        </div>
